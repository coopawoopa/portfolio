<script lang="ts">
	...
	const isWide = mediaQuery('(min-width: 1000px)'); // Media query to detect screen size
							...
							<ScrollArea class="h-full w-full rounded-md">
								<div class="p-4">
									...
									<div class="mt-4 flex justify-end space-x-2">
										<Button
											style=""
											on:click={() => toast.error('Downloading not currently supported')}
											>File</Button
										>
										<Button
											style=""
						...
						<div class="overview">
							<div class="p-4">
								...
								<div class="mt-4 flex justify-end space-x-2">
									<Button
										style=""
										on:click={() => toast.error('Downloading not currently supported')}>File</Button
									>
									<Button
										style=""
										on:click={() => toast.error('Downloading not currently supported')}
